...
| 层          | 核心文件                                                                                                              | 要点                                                                                                                                           |
|------------|-------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|
| Agent      | `AgentLoop`, `AgentSession`, `ToolRegistry`, `ToolExecutor`, `ToolModels`, `PlanExecutor`, `MultiAgentManager`    | 14 个工具：9 内置（Read/Write/Edit/Bash/Glob/Grep/readLints/Task/Skill）+ 5 计划管理（createPlan/listSteps/deleteStep/reorderSteps/markStepDone），while 循环 |
