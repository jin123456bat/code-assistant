...
| [specs/i18n.md](specs/i18n.md)                               | 国际化策略：v1 仅中文，Phase 2+ 多语言方案                      |
...
| Markdown 渲染   | v1 手写字符串解析器，5 种 Block 类型                    | 纯字符串操作无 EDT 约束，详见 [markdown-rendering.md](agent/markdown-rendering.md) |
