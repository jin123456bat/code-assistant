...
class ChatBubbleRendererTest {
    ...
    fun `code blocks forward vertical wheel events to outer message scroll`() {
        val longCodeLine = "val content = \"${"x".repeat(500)}\""
        ...
        listOf(completed, streaming).forEach { bubble ->
            ...
            codeScrollPane.setSize(100, 80)
            codeScrollPane.doLayout()
            codeScrollPane.horizontalScrollBar.unitIncrement = 3
            val horizontalValueBeforeWheel = codeScrollPane.horizontalScrollBar.value
            assertTrue(
                codeScrollPane.horizontalScrollBar.maximum -
                        codeScrollPane.horizontalScrollBar.visibleAmount > horizontalValueBeforeWheel
            )
            ...
            assertEquals(horizontalValueBeforeWheel, codeScrollPane.horizontalScrollBar.value)
            ...
            assertTrue(codeScrollPane.horizontalScrollBar.value > horizontalValueBeforeWheel)
        }
    }
